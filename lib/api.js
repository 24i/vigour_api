    ...
    data: {
      api (data, event) {
        ...
        if (
          payload === void 0 ||
          payload === '' ||
          (typeof payload === 'object' && isEmpty(payload))
        ) {
          return
        }
        ...
        // may need to add something here e.g. event.type loading?
        loading.origin.emit('data', true, event)
